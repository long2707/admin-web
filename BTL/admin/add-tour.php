                                ...
                                <form method="POST" action="add-tour-action.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            ...
                                            <input class="form-control" id="txtDV3" name="txtDV3" placeholder="Nhập Dịch vụ3" />
                                        </div>
                                        <div class="col-md-6 padd-right-0">
                                    ...
                                    <div class="form-group">
                                    <div class="color-md-6 padd-right-0">
                                            <input class="form-control" id="txtGioiThieu" name="txtMoTa" placeholder="Nhập giới thiệu chung về tour" />
